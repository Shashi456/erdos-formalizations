...
| [283](https://www.erdosproblems.com/283) + [351](https://www.erdosproblems.com/351) (in progress) | Polynomial Egyptian sums: `∑ p(n_i) = m, ∑ 1/n_i = α` for any `α ∈ ℚ_{>0}` and qualifying polynomial | [informal.md](Erdos/P283/informal.md) · [proof.pdf](Erdos/P283/proof.pdf) | [Proof.lean](Erdos/P283/Proof.lean) (scaffolded; sorries) |
