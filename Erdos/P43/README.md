...
The combined writeup `Erdos/P42/proof_combined_42_43.pdf` answers both
...
| File | Status |
|------|--------|
| [`Basic.lean`](Basic.lean) | `sidonNumber` definition |
...
| [`FCWrapper.lean`](FCWrapper.lean) | placeholder `True := trivial` |
| [`Proof.lean`](Proof.lean) | umbrella |

## Plan

1. **First half** depends on #42 (`Erdos.P42.FCWrapper.theorem_1_1`); once #42
