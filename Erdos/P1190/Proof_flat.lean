...
/-! =============================================================
    Section from: Erdos/P1190/Proof.lean
    ============================================================= -/
...
lemma exists_tailAdmissible_card_ge_sub_f
  ...
  refine ⟨Q, hQ₀.tail_filter_tailAdmissible, ?_, ?_⟩
  · rw [← hcard]
    exact hQ₀.tail_filter_card_ge_sub
  · intro q hq
...
foundational axioms inherited from `P202Main`.
-/

-- #print axioms erdos1190_bridge_ready

end Erdos202

/-! ## Combined axiom audit -/

#print axioms Erdos202.erdos202_main
#print axioms Erdos202.erdos1190_main
